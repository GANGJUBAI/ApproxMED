...
LoopNum="1500 1000 5 10 50 100 "

#Source set
DataSource="/home/lff/SC2021src/inputData/"
DataSource2="/home/lff/ApproxMD/src/data_generator/"
ResultSoure="/home/lff/ApproxMD/src/result/Eval/Cmp_baselines/3D/Err_MED/"
...
do
       ...
       echo " ********************  $i is being processed  with CG-MED ***********************************"
        ...
        Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
        ./Err_FSM_ori_maxmin $Path 256 384 384 D 3 >> $Result
       
       python3 find.py $Result
       python3 $ResultSoure"accuracy_Count.py" $Result >> $ResultSoure"Err_CG-MED_maxmin"
...
do
       ...
       Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
       ./Err_FSM_ori_maxmin $Path 500 500 100 F 3 >> $Result
...
do
       ...
       Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
       ./Err_FSM_ori_maxmin $Path 512 512 512 F 3 >> $Result
...
do 
        ...
        Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
        ./Err_FSM_ori_maxmin $Path 512 512 1 I 2 >> $Result
...
do 
        ...
        Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
        ./Err_FSM_ori_maxmin $Path 64 64 20 I 2 100 2 >> $Result
...
do 
        ...
        Path=$DataSource2$i".bin"
        Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
        ./Err_FSM_ori_maxmin $Path 10 1000000 I 1 >> $Result
...
do 
        ...
        Path=$DataSource2$i".bin"
        Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
        ./Err_FSM_ori_maxmin $Path 1 10000000 F 1 >> $Result
...
do 
        ...
        Path=$DataSource2$i".bin"
        Result=$ResultSoure"Err_CG/RE_"$i"_maxmin"
        ./Err_FSM_ori_maxmin $Path 3 60 5784 F 2 >> $Result
