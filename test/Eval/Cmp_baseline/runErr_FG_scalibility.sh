...
do
       ...
       echo " ********************  $i is being processed  with FG-MED ***********************************"
        ...
        ./Err_FSM_FG $Path 256 384 384 D 3 >> $Result
...
do
       ...
       Result=$ResultSoure"Err_FG/RE_"$i
       ./Err_FSM_FG $Path 500 500 100 F 3 >> $Result
...
do
       ...
       Result=$ResultSoure"Err_FG/RE_"$i
       ./Err_FSM_FG $Path 512 512 512 F 3 >> $Result
...
do 
        ...
        Result=$ResultSoure"Scalibility/RE_"$i

        j=1
        while [ $j -le 1000 ]; 
        do
            echo " ***************************** $i (loop=$j) is being processed with FG-MED  **************************"
            ./Err_FSM_FG $Path 512 512 $j I 2 > $Result

            python3 find.py $Result
            python3 $ResultSoure"accuracy_Count.py" $Result >> $ResultSoure"Scalibility/Scalibility_FG-MED_lena"
...
python3 find.py $ResultSoure"Scalibility/Scalibility_FG-MED_lena"
...
do 
        ...
        do
            echo " ***************************** $i (loop=$j) is being processed with FG-MED  **************************"
            ./Err_FSM_FG $Path 64 64 20 I 2 $j 2 > $Result

            python3 find.py $Result
            python3 $ResultSoure"accuracy_Count.py" $Result >> $ResultSoure"Scalibility/Scalibility_FG-MED_Minst"
...
python3 find.py $ResultSoure"Scalibility/Scalibility_FG-MED_Minst"
...
do 
        ...
        do
            echo " ***************************** $i (loop=$j) is being processed with FG-MED  **************************"
            ./Err_FSM_FG $Path $j 1000000 I 1 > $Result

            python3 find.py $Result
            python3 $ResultSoure"accuracy_Count.py" $Result >> $ResultSoure"Scalibility/Scalibility_FG-MED_zipf"
...
python3 find.py $ResultSoure"Scalibility/Scalibility_FG-MED_zipf"
...
do 
        ...
        do
            echo " ***************************** $i (loop=$j) is being processed with FG-MED  **************************"
            ./Err_FSM_FG $Path $j 10000000 F 1 > $Result

            python3 find.py $Result
            python3 $ResultSoure"accuracy_Count.py" $Result >> $ResultSoure"Scalibility/Scalibility_FG-MED_norm"
...
python3 find.py $ResultSoure"Scalibility/Scalibility_FG-MED_norm"
