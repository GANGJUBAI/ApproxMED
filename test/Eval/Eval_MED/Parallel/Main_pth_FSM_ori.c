    ...
    {                                                                                        \
        ...
        {                                                                                    \
            ...
            {                                                                                \
                ...
                {                                                                            \
                case 0:                                                                      \
                    mediantemp = medianFindStage1(T)(Level_X, 8, cols, &my_mean, &my_sigma); \
                    findMedianStage = 1;                                                     \
                    break;                                                                   \
                case 1:                                                                      \
                    mediantemp = medianFindStage2(T)(Level_X, 8, cols, &my_mean, &my_sigma); \
                    break;                                                                   \
                default:                                                                     \
                    printf("error\n");                                                       \
                    break;                                                                   \
...
#define _process_stream_IMPL(T)                                                                                 \
    ...
    {                                                                                                           \
        ...
        printf("Approximate ori finding time is %fms\n", endtime);                                              \
                                                                                                                \
        fclose(ori_fp);                                                                                         \
        ori_fp = NULL;                                                                                          \
                                                                                                                \
